  ...
  return (
    <div className="pt-20 bg-black min-h-screen font-body">
      ...
      <div className="relative py-24 border-b border-white/10 overflow-hidden">
        <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1492684223066-81342ee5ff30?q=80&w=2070&auhref=format&fit=crop')] bg-cover bg-center opacity-40"></div>
        ...
        <div className="bg-white/5 border border-white/10 p-10 rounded-3xl mb-24 relative overflow-hidden">
           ...
           <div className="relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                 ...
                 <button className="px-10 py-5 bg-white text-black font-black uppercase tracking-[0.2em] rounded-xl hover:bg-ear-gold transition-colors shadow-2xl flex items-center gap-2">
