...
| `EAR-ROSTER-EA-350`| **Contratación Solista Edwin Agudelo (Caché Base)** | Roster Oficial | **350,00 €** (+0,75€/km) | Liquidación con Split | 80% Prov / 10% EAR / 10% VIM | `/artistas/edwin-agudelo`<br>`/artistas/[slug]`<br>`/checkout/presupuesto` |
