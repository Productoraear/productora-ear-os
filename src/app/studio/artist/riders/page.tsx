      ...
      <div className="grid lg:grid-cols-3 gap-12">
        <div className="lg:col-span-2 space-y-8">
          ...
          <div className="space-y-4">
            <RiderRow version="2.1" date="14/05/2026" name="Rider Oficial - Gira 2026" status="ACTIVO" isCurrent />
            <RiderRow version="2.0" date="02/02/2026" name="Rider Acústico / Corporativo" status="ARCHIVADO" />
            <RiderRow version="1.8" date="12/12/2025" name="Rider - Festivales 2025" status="ARCHIVADO" />
          </div>
        </div>
          ...
          <div className="bg-[#0d0d0d] border border-white/5 p-10 rounded-[3rem] space-y-8 relative overflow-hidden">
            ...
            <div className="relative z-10 space-y-6">
              ...
              <div className="pt-6 border-t border-white/5">
                <Link href="/studio/artist/riders" className="flex items-center justify-between group/link">
