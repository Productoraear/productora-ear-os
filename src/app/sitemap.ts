...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const neuroFunnelProgrammaticPages: MetadataRoute.Sitemap = [
    ...
    // 10.B. NODOS DE DOMINANCIA EUROPEA (DESTINATION WEDDINGS & LUXURY GALAS)
    { vertical: 'bodas', intent: 'destination-wedding-ibiza-mariachi-dj' },
    { vertical: 'bodas', intent: 'destination-wedding-mallorca-luxury-music' },
    { vertical: 'bodas', intent: 'marbella-luxury-wedding-tenor-show' },
    { vertical: 'bodas', intent: 'paris-mariachi-gala-destination-wedding' },
    { vertical: 'bodas', intent: 'cote-azur-nice-monaco-luxury-events' },
    { vertical: 'bodas', intent: 'lake-como-florence-tenor-wedding-gala' },
    { vertical: 'bodas', intent: 'rome-luxury-wedding-live-music' },
    { vertical: 'bodas', intent: 'lisbon-cascais-destination-wedding-show' },
    { vertical: 'bodas', intent: 'london-corporate-gala-mariachi-tenor' },
    { vertical: 'corporativo', intent: 'paris-corporate-event-sound-led-screens' },
    { vertical: 'corporativo', intent: 'milan-fashion-week-sound-lighting' },
    { vertical: 'corporativo', intent: 'monaco-yacht-show-vip-entertainment' },
    { vertical: 'corporativo', intent: 'zurich-private-banking-gala-tenor' },
    { vertical: 'corporativo', intent: 'berlin-corporate-audiovisual-production' },
  ].map(node => ({
