  ...
  return (
    ...
    >
      <div className="flex items-center gap-3 mb-4">
        ...
        <h3 className="text-xs font-black uppercase tracking-[0.3em] text-white/80">AstraVoiceModule</h3>
      </div>
