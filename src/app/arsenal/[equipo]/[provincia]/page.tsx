...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return {
    title: `Alquiler de ${equipoFormatted} en ${provinciaFormatted} | Productora EAR Arsenal B2B`,
    ...
    openGraph: {
      title: `Alquiler de ${equipoFormatted} en ${provinciaFormatted} - Arsenal B2B Productora EAR`,
      description: `Soluciones de pantallas LED, sonorización y pantallas 4K para eventos en ${provinciaFormatted}.`,
    },
  };
}
...
export default async function ArsenalEquipoProvinciaPage({ params }: PageProps) {
  ...
  const whatsappMessage = encodeURIComponent(
    `Hola, quiero verificar disponibilidad técnica para ${equipoFormatted} en ${provinciaFormatted}.`
  );
    ...
    <main className="min-h-screen bg-[#050505] text-white selection:bg-[#ecb613] selection:text-black font-sans">
      <section className="relative pt-24 pb-16 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        ...
        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-[#ecb613]/30 bg-[#ecb613]/5 text-[#ecb613] text-xs uppercase tracking-widest mb-6">
          ...
          S-Class Technical Arsenal B2B
        </div>

        <h1 className="text-4xl sm:text-6xl font-extrabold tracking-tight text-white mb-4">
          Alquiler de <span className="text-transparent bg-clip-text bg-gradient-to-r from-amber-200 via-[#ecb613] to-amber-500">{equipoFormatted}</span> en {provinciaFormatted}
        </h1>
        ...
        <p className="text-lg sm:text-xl text-neutral-400 max-w-3xl mb-8">
          ...
          Montaje profesional, calibración acústica/visual y asistencia técnica in-situ para eventos corporativos, bodas y producción B2B en {provinciaFormatted}.
        </p>
      ...
      <section className="py-12 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto border-t border-neutral-900">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="p-6 rounded-2xl bg-neutral-900/50 border border-neutral-800 hover:border-[#ecb613]/30 transition-all">
            ...
            <h3 className="text-xl font-semibold text-white mb-2">{equipoFormatted} High-Refresh</h3>
      ...
      <section className="py-16 px-4 text-center border-t border-neutral-900 bg-gradient-to-b from-transparent to-[#ecb613]/5">
        ...
        <p className="text-neutral-400 mb-8 max-w-xl mx-auto">
          Reserva tu equipamiento audiovisual con confirmación técnica inmediata.
        </p>
        <a
          href={whatsappUrl}
          target="_blank"
        ...
        >
          Consultar Disponibilidad de {equipoFormatted} (+34 693 693 048)
        </a>
      </section>
    </main>
  );
