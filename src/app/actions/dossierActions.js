...
export async function approveDossier(dossierId, token) {
    ...
    const telegramTarget = LeadRouter.getTelegramTarget(dossier.channel);
    const message = `
...
${dossier.selected_assets.map((a) => `- ${a}`).join('\n')}
