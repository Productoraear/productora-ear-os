    ...
    <main className="bg-[#050505] min-h-screen text-white selection:bg-[#ecb613]/30">
      ...
      <div className="relative h-[70vh] w-full">
        ...
        <div className="absolute top-32 left-6 md:left-20">
          <Link 
            href={`/blog/${category}`}
            className="inline-flex items-center gap-2 text-[10px] font-black uppercase tracking-[0.4em] text-white/50 hover:text-[#ecb613] transition-colors bg-black/40 backdrop-blur-xl px-6 py-3 rounded-full border border-white/5"
          >
      ...
      <div className="max-w-4xl mx-auto px-6 -mt-32 relative z-10 space-y-12 pb-32">
        ...
        <footer className="pt-12 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-8">
          ...
          <Link 
            href="/contacto"
            className="bg-[#ecb613] text-black px-12 py-5 rounded-2xl font-black uppercase text-[10px] tracking-[0.4em] hover:scale-105 transition-all shadow-xl"
          >
