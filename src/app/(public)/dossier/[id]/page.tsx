      ...
      <div className="container-custom max-w-4xl">
        ...
        <section className="mb-24">
          ...
          <div className="space-y-6">
            {dossier.selected_assets.map((assetId: string, i: number) => (
              <div key={i} className="group p-8 bg-white/5 border border-white/5 rounded-3xl flex items-center justify-between hover:bg-white/10 transition-all">
                <div className="flex items-center gap-6">
