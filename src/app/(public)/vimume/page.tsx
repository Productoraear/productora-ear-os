...
export default function VimumePage() {
  ...
  return (
    <div className="min-h-screen bg-[#030305] text-[#f5f1e8] selection:bg-[#8b5cf6] selection:text-white font-sans overflow-x-hidden">
      <script
      ...
      <main id="portal" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-12 pb-20 relative z-20 bg-[#030305] overflow-x-hidden">
