...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return {
    title: `Servicios de ${servicioFormatted} en ${provinciaFormatted} | Productora EAR`,
    description: `Servicios profesionales de ${servicioFormatted} en ${provinciaFormatted}. Infraestructura técnica audiovisual S-Class, transporte homologado, montaje y técnico in-situ con garantía 0 Fallos.`,
    openGraph: {
      title: `Servicios de ${servicioFormatted} en ${provinciaFormatted} - Productora EAR`,
      description: `Soluciones de sonorización, iluminación y producción audiovisual para eventos en ${provinciaFormatted}.`,
    },
  };
}
...
export default async function ServiciosProvinciaPage({ params }: PageProps) {
  ...
  const whatsappMessage = encodeURIComponent(
    `Hola, quiero verificar disponibilidad técnica para ${servicioFormatted} en ${provinciaFormatted}.`
  );
    ...
    <main className="min-h-screen bg-[#050505] text-white selection:bg-[#ecb613] selection:text-black font-sans">
      <section className="relative pt-24 pb-16 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        ...
        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-[#ecb613]/30 bg-[#ecb613]/5 text-[#ecb613] text-xs uppercase tracking-widest mb-6">
          ...
          S-Class Technical Services B2B
        </div>

        <h1 className="text-4xl sm:text-6xl font-extrabold tracking-tight text-white mb-4">
          Servicios de <span className="text-transparent bg-clip-text bg-gradient-to-r from-amber-200 via-[#ecb613] to-amber-500">{servicioFormatted}</span> en {provinciaFormatted}
        </h1>
        ...
        <p className="text-lg sm:text-xl text-neutral-400 max-w-3xl mb-8">
          ...
          Servicios profesionales, calibración acústica/visual y asistencia técnica in-situ para eventos corporativos, bodas y producción B2B en {provinciaFormatted}.
        </p>
      ...
      <section className="py-16 px-4 text-center border-t border-neutral-900 bg-gradient-to-b from-transparent to-[#ecb613]/5">
        <h2 className="text-3xl font-extrabold text-white mb-4">¿Tienes una fecha para tu evento en {provinciaFormatted}?</h2>
        <p className="text-neutral-400 mb-8 max-w-xl mx-auto">
          Reserva tus servicios audiovisuales con confirmación técnica inmediata.
        </p>
        <a
          href={whatsappUrl}
          target="_blank"
        ...
        >
          Consultar Disponibilidad de {servicioFormatted} (+34 693 693 048)
        </a>
      </section>
    </main>
  );
