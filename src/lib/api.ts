...
export interface QuoteData {
  ...
  amount: number;
  currency: string;
  // Added concept to resolve the error in PaymentModal.tsx
  concept?: string;
  breakdown: any;
  client_id?: string;
  timestamp: string;
...
export const api = {
   ...
   */
  submitLead: async (lead: LeadData) => {
   ...
   */
  submitEventRequest: async (request: EventRequestData) => {
   ...
   */
  submitQuote: async (quote: QuoteData) => {
