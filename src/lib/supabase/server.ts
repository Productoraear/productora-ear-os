...
<meta property="og:image:height" content="200">
    ...
    <title>shlex — Simple lexical analysis &#8212; Python 3.14.0 documentation</title><meta name="viewport" content="width=device-width, initial-scale=1.0">
    ...
    <link rel="next" title="posix — The most common POSIX system calls" href="posix.html" />
...
<li><a class="reference internal" href="#improved-compatibility-with-shells">Improved Compatibility with Shells</a></li>
  ...
  <div>
    ...
    <p class="topless"><a href="posix.html"
                          title="next chapter"><code class="xref py py-mod docutils literal notranslate"><span class="pre">posix</span></code> — The most common POSIX system calls</a></p>
  </div>
  <div role="note" aria-label="source link">
    ...
    <ul class="this-page-menu">
      ...
      <li>
        <a href="https://github.com/python/cpython/blob/main/Doc/library/shlex.rst?plain=1"
...
<p><strong>Source code:</strong> <a class="extlink-source reference external" href="https://github.com/python/cpython/tree/3.14/Lib/shlex.py">Lib/shlex.py</a></p>
<hr class="docutils" />
