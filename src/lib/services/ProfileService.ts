...
export class ProfileService {
   ...
   */
  static async createArtistProfile(userId: string, data: ArtistProfileData) {
    try {
  ...
  // In the future, we can add other profile creation methods here
  // static async createProviderProfile(userId: string, data: any) { ... }
}
