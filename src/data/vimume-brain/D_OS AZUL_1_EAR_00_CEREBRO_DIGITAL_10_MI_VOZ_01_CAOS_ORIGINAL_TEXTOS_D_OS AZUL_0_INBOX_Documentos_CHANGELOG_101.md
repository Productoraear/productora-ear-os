    ...
    var segmentScript = function () {
        ...
        (async () => {
          ...
          [ga4ClientId, ga4SessionId, ga4SessionNumber] = await Promise.all([ga4ClientIdPromise, ga4SessionIdPromise, ga4SessionNumberPromise]);
            const pageProperties = {"nItems":103,"reduced":"\/catalog\/list","gpAnonId":"2faa1ae2-b846-4000-82e6-08cd18663f24","loggedVendorUUID":"587e0718-0168-4bc7-9b54-bfbcc0c68a82","isMasquerading":false,"platform":"desktop web","section":"\/catalog\/list","build_product":"fashion"};
            ...
            analytics.addSourceMiddleware(function (middlewareIntermediate) {
                ...
                if (payload.obj.type === 'page') {
                  payload.obj[namespace]['event_id'] = 'pageview_' + window.userGlobals.gp_anon_id + '_' + '101d8a13-8778-4c1e-8211-a92678b99987'
                }
...
<div class="dnone">
                ...
                gtag('event', 'page_view', {"CATALOG_NAV":1,"LOGGED":0,"EMPRESA":1,"EMPRESA_CATEGORY":"9","EMPRESA_CLIENT":1,"send_to":"adwords","user_id":"e78903"});
                  ...
                  var toExecuteAfterFbInit = function () {                  
                      ...
                      parent.fbq('track', 'PageView', {"CATALOG_NAV":1,"LOGGED":0,"EMPRESA":1,"EMPRESA_CATEGORY":"9","EMPRESA_CLIENT":1}, {eventID: 'pageview_' + window.userGlobals.gp_anon_id + '_' + '101d8a13-8778-4c1e-8211-a92678b99987'}); parent.fbq('dataProcessingOptions', ['LDU'], 0, 0); 
                  }
    ...
    <script>
      window.addEventListener('newRelicScriptLoaded', function() {
          ...
          newRelicScript("307408989");
              ...
              {"@context":"http:\/\/schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"Bodas","item":"https:\/\/www.bodas.net\/"},{"@type":"ListItem","position":2,"name":"Vestidos de Novia","item":"https:\/\/www.bodas.net\/vestidos-novias"}]}            </script>
        </div>
