    ...
    var segmentScript = function () {
        ...
        (async () => {
          ...
          [ga4ClientId, ga4SessionId, ga4SessionNumber] = await Promise.all([ga4ClientIdPromise, ga4SessionIdPromise, ga4SessionNumberPromise]);
            const pageProperties = {"reduced":"\/groups\/user\/friends","gpAnonId":"2faa1ae2-b846-4000-82e6-08cd18663f24","isMasquerading":false,"platform":"desktop web","section":"community","build_product":"community"};
            ...
            analytics.addSourceMiddleware(function (middlewareIntermediate) {
                ...
                if (payload.obj.type === 'page') {
                  payload.obj[namespace]['event_id'] = 'pageview_' + window.userGlobals.gp_anon_id + '_' + 'af00600c-fb0b-47c3-a5f5-fc1b1ba734ca'
                }
...
<div class="dnone">
                ...
                gtag('event', 'page_view', {"COMMUNITY_NAV":1,"LOGGED":0,"EMPRESA":0,"EMPRESA_CATEGORY":0,"send_to":"adwords"});
                  ...
                  var toExecuteAfterFbInit = function () {                  
                      ...
                      parent.fbq('track', 'PageView', {"COMMUNITY_NAV":1,"LOGGED":0,"EMPRESA":0,"EMPRESA_CATEGORY":0}, {eventID: 'pageview_' + window.userGlobals.gp_anon_id + '_' + 'af00600c-fb0b-47c3-a5f5-fc1b1ba734ca'}); parent.fbq('dataProcessingOptions', ['LDU'], 0, 0); 
                  }
