# 🏛️ MEMORIA TÉCNICA Y ECONÓMICA DE CONTRATACIÓN PÚBLICA (LCSP)
**DESTINATARIO:** Ilustrísimo Ayuntamiento de Soria Capital (Soria)  
**ÓRGANO DE CONTRATACIÓN:** Concejalía de Cultura y Bienestar Social  
**RÉGIMEN CONTRACTUAL:** Contrato Menor de Servicios (Art. 118 Ley 9/2017 LCSP)  
**EXPEDIENTE:** EAR-B2G-SORIA_CAPITAL-2026  
**FECHA DE EMISIÓN:** 25/08/2026  

---

## 1. JUSTIFICACIÓN DE LA NECESIDAD Y OBJETO DEL SERVICIO
El presente proyecto tiene por objeto la prestación del servicio de **"Entretenimiento Terapéutico y Estimulación Neuroacústica — Programa VIMUME (Viaje Musical por la Memoria)"**, diseñado específicamente para el colectivo de personas mayores y vecinos del municipio de **Soria Capital**.
...
| :--- | :--- | :--- | :--- |
| **Programa VIMUME_EXPANDIDO en Soria Capital** | 750.00 € | 157.50 € | **907.50 €** |
