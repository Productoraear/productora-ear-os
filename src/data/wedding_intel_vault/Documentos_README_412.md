    ...
    <div class="wrapper">
        <div class="breadcrumb-container">
                    <ul class="breadcrumb">
                            ...
                            <li   >
                                            Converse Swarovski Aurora (Mimanera)                                                        </li>
                    </ul>
                        ...
                        <div class="pure-u-1-5">
                            <div class="sliderDressesThumbs app-thumbnail-slider-wrapper">
                                    ...
                                    <div class="swiper-wrapper-no-css">
                                                    ...
                                                    <img src="https://cdn0.bodas.net/cat/739806--mfvr739806.jpg"  class="sliderDressesThumbs__image app-dress-change-slider active pointer" alt="Converse Swarovski Aurora, Mimanera"  width="108" height="137"   >
                                            </div>
                                                                                    <div class="swiper-slide-no-css sliderDressesThumbs__item">
                                                    <img src="https://cdn0.bodas.net/cat/739808--mfvr739808.jpg"  class="sliderDressesThumbs__image app-dress-change-slider pointer