e.com/user/bodasnet/featured" title="Youtube" target="_blank"><i class="svgIcon app-svg-async svgIcon__youtube-filled "   data-svg="https://cdn1.bodas.net/assets/svg/optimized/_common/youtube-filled.svg" data-svg-lazyload="1"></i></a></li>
    ...
    var segmentScript = function () {
        ...
        (async () => {
          ...
          [ga4ClientId, ga4SessionId, ga4SessionNumber] = await Promise.all([ga4ClientIdPromise, ga4SessionIdPromise, ga4SessionNumberPromise]);
            const pageProperties = {"nItems":8,"reduced":"\/catalog\/list","gpAnonId":"2faa1ae2-b846-4000-82e6-08cd18663f24","isMasquerading":false,"platform":"desktop web","section":"\/catalog\/list","build_product":"fashion"};
            ...
            analytics.addSourceMiddleware(function (middlewareIntermediate) {
                ...
                if (payload.obj.type === 'page') {
                  payload.obj[namespace]['event_id'] = 'pageview_' + window.userGlobals.gp_anon_id + '_' + 'b0e1073c-3938-4861-a06b-d46efeaf9e35'
                }
...
<div class="dnone">
                ...
                gtag('event', 'page_view', {"CATALOG_NAV":1,"LOGGED":0,"EMPRESA":0,"EMPRESA_CATEGORY":0,"send_to":"adwords"});
                  ...
                  var toExecuteAfterFbInit = function () {                  
                      ...
                      parent.fbq('track', 'PageView', {"CATALOG_NAV":1,"LOGGED":0,"EMPRESA":0,"EMPRESA_CATEGORY":0}, {eventID: 'pageview_' + window.userGlobals.gp_anon_id + '_' + 'b0e1073c-3938-4861-a06b-d46efeaf9e35'}); parent.fbq('dataProcessingOptions', ['LDU'], 0, 0); 
                  }
                ...
                document.getElementsByTagName('body')[0].addEventListen