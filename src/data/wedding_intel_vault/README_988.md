...
gtag('event', 'view_search_results', {"send_to":"adwords","listing_id":[31312],"listing_pagetype":"searchresults"});
</script>              <script>
...
parent.fbq('track', 'PageView', {"VENUES_NAV":1,"VENDORS_29_NAV":1,"LOGGED":0,"EMPRESA":0,"EMPRESA_CATEGORY":0}, {eventID: 'pageview_' + window.userGlobals.gp_anon_id + '_' + '9a27a582-4d8b-46d9-a916-a686755e9aa2'}); parent.fbq('dataProcessingOptions', ['LDU'], 0, 0);
}
...
parent.pintrk('page');
parent.pintrk('track', 'custom', {"VENUES_NAV":"1","VENDORS_29_NAV":"1","LOGGED":"0","EMPRESA":"0","EMPRESA_CATEGORY":"0","send_to":"adwords"});
}
}
...
<script type="application/ld+json">
[{"@context":"http:\/\/schema.org","@type":"LocalBusiness","logo":"https:\/\/cdn0.bodas.net\/vendor\/31312\/3_2\/960\/png\/Convento%20San%20Francisco.webp","url":"https:\/\/www.bodas.net\/salones-de-boda\/convento-san-francisco--e31312","name":"Convento San Francisco","image":"restaurante_1_31312.jpg","address":{"@type":"PostalAddress","streetAddress":"Convento San Francisco - Santo Domingo de Silos","postalCode":"09610","addressLocality":"Santo Domingo De Silos","addressRegion":"Burgos"},"aggregateRating":{"@type":"AggregateRating","reviewCount":1,"ratingValue":"5.0","worstRating":0,"bestRating":5}}]            </script>
