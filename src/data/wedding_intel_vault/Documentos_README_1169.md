TabDressesFeatured__content">
            ...
            <li class="nav-main-item  nav-tabArticles">
                ...
                class="nav-main-link app-header-tab  app-ua-track-event"
                 data-track-c='NavigationAuthed' data-track-a='a-click' data-track-l='d-desktop+s-header+o-vendors_promotions_list+dt-ideas' data-track-v='0' data-track-ni='0'        