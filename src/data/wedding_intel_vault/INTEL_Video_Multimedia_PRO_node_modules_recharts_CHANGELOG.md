...
<div class="breadcrumb-box"><div class="wrapper"><div class="breadcrumb-container"><ul class="breadcrumb"><li><a href="https://www.bodas.net/">Bodas</a></li><li><a href="https://comunidad.bodas.net/">Comunidad</a></li><li><h1>Antia</h1></li></ul>    <div id="search" class="animate-search">
            ...
            <text transform="translate(100,130)" y="0">
                ...
                <div class="com-profile-hero-content">
                    <div class="com-profile-info mt5">
                        <span class="com-profile-hero-name">Antia</span>
                                                                        <div class="com-profile-hero-info">
                            <p>
                                                                                                                                            Lucena, Córdoba                                        ·
                                                                                                                Desde Mayo del 2024                                                                                                </p>
                                                    </div>
                    </div>
                                            <div class="com-profile-hero-action">
                                                                                                                <button class="btnFlat btnFlat--primary red mr5 app-user-friends-card-add " data-id-user="8436386" data-origin="1" data-outline="1">
                                                <i class="svgIcon app-svg-async svgIcon__addFriend svgIcon--large svgIcon--white svgIcon--middle"   data-svg="https://cdn1.bodas.net/assets/svg/optimized/tools/addFriend.svg" data-svg-lazyload="1"></i>                                                Seguir                                            </button>
                                                                                                                                                                                                                                        <ul class="com-profile-awards ml10">
                                <li>
                                                                            <span class="user-rank icon-community-rank icon-community-rank-level5 icon-left">Novia Adicta</span>
                                                                                                        </li>
                                                                    <li class="com-profile