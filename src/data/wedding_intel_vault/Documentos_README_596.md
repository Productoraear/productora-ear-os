...
<h2 class="storefrontGalleryMosaicFullscreen__title app-gallery-fullscreen-title" data-vendor-name="Cortijo Galván">
Cortijo Galván            </h2>
...
<button type="button" class="button button--tertiary">Fotos<span>41</span></button>
</li>
...
<button type="button" class="button button--tertiary">Bodas reales<span>89</span></button>
</li>
<li class="galleryNavigation__item app-gallery-fullscreen-change" data-media="reviewPhoto">
<button type="button" class="button button--tertiary">Fotos opiniones<span>57</span></button>
</li>
</ul>
</nav>
</div>
...
<div class="inspireTrust">
<i class="svgIcon app-svg-async svgIcon__thunder inspireTrust__icon"   data-svg="https://cdn1.bodas.net/assets/svg/optimized/_common/thunder.svg" data-svg-lazyload="1"></i>    Responde en 