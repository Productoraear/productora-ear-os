s://www.bodas.net/condiciones-legales.php">Condiciones legales</a>
        </li>
                    <li>
...
<script>
    var pageGlobals = {
                                            reduced: '/groups/item/photos/list'            
                            ,                                                             currentPageData:[]            
...
<script>
    var reduced = '/groups/item/photos/list';
    </script>
    ...
    var segmentScript = function () {
        ...
        (async () => {
          ...
          [ga4ClientId, ga4SessionId, ga4SessionNumber] = await Promise.all([ga4ClientIdPromise, ga4SessionIdPromise, ga4SessionNumberPromise]);
            const pageProperties = {"reduced":"\/groups\/item\/photos\/list","gpAnonId":"2faa1ae2-b846-4000-82e6-08cd18663f24","isMasquerading":false,"platform":"desktop web","section":"community","build_product":"community"};
            ...
            analytics.addSourceMiddleware(function (middlewareIntermediate) {
                ...
                if (payload.obj.type === 'page') {
                  payload.obj[namespace]['event_id'] = 'pageview_' + window.userGlobals.gp_anon_id + '_' + 'cb473bb4-2f7e-47f1-a80a-08e5e34b6248'
                }
