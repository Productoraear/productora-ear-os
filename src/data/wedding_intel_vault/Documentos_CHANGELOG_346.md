targetedAdsOpt = isCookieGroupAllowed(CONSENT_TARGETED_ADVERTISING_GROUP) === true;
            ...
            analytics.addSourceMiddleware(function (middlewareIntermediate) {
                ...
                if (payload.obj.type === 'page') {
                  payload.obj[namespace]['event_id'] = 'pageview_' + window.userGlobals.gp_anon_id + '_' + '7df59be5-1e93-49c0-b167-3e7ccd7f7ed3'
                }
...
<div class="dnone">
                ...
                gtag('event', 'page_view', {"COMMUNITY_NAV":1,"LOGGED":0,"EMPRESA":0,"EMPRESA_CATEGORY":0,"send_to":"adwords"});
                  ...
                  var toExecuteAfterFbInit = function () {                  
                      ...
                      parent.fbq('track', 'PageView', {"COMMUNITY_NAV":1,"LOGGED":0,"EMPRESA":0,"EMPRESA_CATEGORY":0}, {eventID: 'pageview_' + window.userGlobals.gp_anon_id + '_' + '7df59be5-1e93-49c0-b167-3e7ccd7f7ed3'}); parent.fbq('dataProcessingOptions', ['LDU'], 0, 0); 
                  }
