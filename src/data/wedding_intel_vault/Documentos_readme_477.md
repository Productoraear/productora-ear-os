...
></div>
<style>
.listingHeading:before { background-image: url(/assets/svg/source/vendors/heading-mask.svg), url(/assets/img/directory/headings/bg_directory-hero-vestidos-arras.jpg) ;}
</style>
<header class="listingHeading app-heading   ">
<h1 class="listingHeading__title">Vestidos de niña de fiesta en Almería</h1>
...
value="Almería"
/>
<span class="searcherOpenModal__input  app-searcher-location-input-tracking" data-last-value="Almería">
Almería            </span>
</div>
</div>
...
name="txtLocSearch"
autocomplete="off">
<span data-href="https://www.bodas.net/busc.php?isClearGeo=1&id_grupo=3&id_sector=59" class="searcher__locationReset app-searcher-reset-location">
