...
<h1 class="listingHeading__title">Lugares para Boda Islas Baleares</h1>
...
/>
<span class="searcherOpenModal__input  app-searcher-location-input-tracking" data-last-value="Islas Baleares">
Islas Baleares            </span>
</div>
</div>
...
aria-expanded="true"
tabindex="0">
<i class="svgIcon app-svg-async svgIcon__angleDown filterOptions__icon"   data-svg="https://cdn1.bodas.net/assets/svg/optimized/_common/angleDown.svg" data-svg-lazyload="1"></i>                    Lugares para Boda            </button>
...
<ul id="menu" class="filterOptions__list app-listing-filter-price-range-list app-filt