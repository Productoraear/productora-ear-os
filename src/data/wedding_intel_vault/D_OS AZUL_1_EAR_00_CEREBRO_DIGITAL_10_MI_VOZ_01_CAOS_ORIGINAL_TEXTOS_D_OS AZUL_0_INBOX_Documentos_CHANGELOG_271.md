    ...
    var segmentScript = function () {
        ...
        (async () => {
          ...
          [ga4ClientId, ga4SessionId, ga4SessionNumber] = await Promise.all([ga4ClientIdPromise, ga4SessionIdPromise, ga4SessionNumberPromise]);
            const pageProperties = {"nItems":42,"reduced":"\/catalog\/list","gpAnonId":"2faa1ae2-b846-4000-82e6-08cd18663f24","loggedVendorUUID":"587e0718-0168-4bc7-9b54-bfbcc0c68a82","isMasquerading":false,"platform":"desktop web","section":"\/catalog\/list","build_product":"fashion"};
            ...
            analytics.addSourceMiddleware(function (middlewareIntermediate) {
                ...
                if (!payload.obj[namespace]) {
                    console.warn('[ga4 segment patch] Analytics event