...
export default function TheSignalFunnel() {
  ...
  const handleFinalSubmit = async () => {
    ...
    try {
      ...
      console.error("[TheSignalFunnel] Error submitting lead:", error);
    } finally {
  ...
  const TheGreatDivide = () => (
    <div className="relative min-h-[85vh] flex flex-col items-center justify-center p-6 overflow-hidden">
      {/* Glow Rings */}
  ...
  const ArtistForm = () => (
    <div className="min-h-[70vh] py-12 px-6 flex justify-center items-center relative overflow-hidden">
