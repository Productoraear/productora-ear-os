...
const profiles = [
  {
    id: 'provider_b2b',
    title: 'Proveedor / Partner',
    subtitle: 'Espacios, Fincas, Catering, Decoración y Reclamación de Ficha',
    icon: Shield,
    color: 'border-[#ecb613]/40 hover:border-[#ecb613]',
    targetRoute: '/login?role=proveedor&from=/servicios',
    badge: 'Verificación S-Class',
  },
  {
    id: 'artist_talent',
    title: 'Artista / Producción',
    subtitle: 'Roster Exclusivo, Mariachis, Edwin Agudelo y Gestión de Riders',
    icon: Music,
    color: 'border-[#ecb613]/40 hover:border-[#ecb613]',
    targetRoute: '/login?role=artista&from=/artistas',
    badge: 'Matching Activo',
  },
  {
    id: 'b2g_institutional',
    title: 'Institución / B2G',
    subtitle: 'Ayuntamientos, Fondos UE, Protocolo Oficial y Licitaciones',
    icon: Building2,
    color: 'border-[#ecb613]/40 hover:border-[#ecb613]',
    targetRoute: '/login?role=institucion&from=/blog/b2g',
    badge: 'Protocolo Oficial',
  },
  {
    id: 'client_events',
    title: 'Cliente de Eventos',
    subtitle: 'Wedding Planners, Bodas, Empresas y Experiencias Bespoke',
    icon: HeartHandshake,
    color: 'border-[#ecb613]/40 hover:border-[#ecb613]',
    targetRoute: '/login?role=cliente&from=/servicios',
